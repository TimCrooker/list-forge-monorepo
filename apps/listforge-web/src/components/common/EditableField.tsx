...
import { Input, Textarea, Button, cn } from '@listforge/ui';
...
interface EditableFieldProps {
  ...
  /** Save handler - can be sync or async */
...
/**
 * EditableField - Unified inline editable field component
 *
 * Supports text, textarea, number, and price types with optional async save,
 ...
 * <EditableField
 *   value={item.title}
 *   onSave={async (newValue) => await updateItem({ title: newValue })}
 *   label="Title"
 *   maxLength={100}
 * />
 * ```
...
export function EditableField({
  ...
  return (
    <div
      className={cn(
        'group flex items-start gap-2 cursor-pointer rounded-md py-1 px-2 -mx-2 transition-colors',
